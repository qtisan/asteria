...
# p = Path(__file__).parent.parent / 'apps/stocking/data/trained/temp/xy.csv'
...
# j = '{"ys": [{ "name": "jjj你好", "thre": 3 }, {"name": "qwe", "thre":-1}]}'
# d = json.loads(j)

# fs = '{0}'.format('|'.join(d['ys'][0].keys()))
# sx = 'name_chg_4'

# reg = '^(feature)_chg_(\\d*)$'.replace('feature', fs)
